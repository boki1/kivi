...
class identifier : public syntactic_structure
{
  ...
  public:
	...
	{
		return name() == other.name() && get_type() == other.get_type();
	}

  public:
	[[nodiscard]] identifier::type get_type() const noexcept
	{
		return m_type;
	}
...
{
  public:
	typedef std::variant<std::monostate, identifier, std::string, int>
		terminal_type; //< Used when representing a terminal expression
  ...
  public:
	[[nodiscard]] const std::vector<expression> &operands() const noexcept
	{
		return m_operands;
	}

	[[nodiscard]] std::vector<expression> operands_copy() const noexcept
	{
		return m_operands;
	}

	[[nodiscard]] const expression::terminal_type &terminal() const noexcept
	{
		return m_terminal_value;
	}

	[[nodiscard]] expression::type get_type() const noexcept
	{
		return m_type;
	}
};
...
class function : public syntactic_structure
{
  ...
  public:
	...
	[[nodiscard]] int locals() const noexcept
	{
		return m_locals;
	}

	[[nodiscard]] int parameters() const noexcept
	{
		return m_parameters;
	}

	[[nodiscard]] const expression &body() const noexcept
	{
		return m_body;
	}
