...
parsing_context::define_identifier (const identifier &ident)
{
    ...
    bool is_duplicate
	= std::any_of (all_scopes ().begin (), all_scopes ().end (),
...
parsing_context::define_local (const std::string &name)
{
    ...
    return define_identifier (identifier (identifier_class::Local, name));
}
...
parsing_context::define_function (const std::string &name)
{
    ...
    return define_identifier (identifier (identifier_class::Function, name));
}
...
parsing_context::define_parameter (const std::string &name)
{
    ...
    return define_identifier (identifier (identifier_class::Parameter, name));
}
